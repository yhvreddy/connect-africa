let genreFetchListDataUrl = $("#genreFetchListDataUrl").val();
var genreFetchDataToTable = $("#genreFetchDataToTable").DataTable({
    processing: true,
    serverSide: true,
    lengthChange: false,
    scrollCollapse: true,
...
$(document).on("click", ".btn-activate", function (e) {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            genreFetchDataToTable.ajax.reload();
        },
...
$("#customPageLength").on("change", function (e) {
    genreFetchDataToTable.page.len($(this).val()).draw();
});
