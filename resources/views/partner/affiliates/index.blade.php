...
@section('breadcrumb-title')
    <h3>Affiliates List</h3>
@endsection

@section('breadcrumb-items')
    <li class="breadcrumb-item">{{app('truFlix')->getSessionUser()->role->title}}</li>
    <li class="breadcrumb-item active">Affiliates List</li>
@endsection
...
<div class="container-fluid">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-1">
                            <a href="javascript:void(0)" id="searchFilterButton" class="btn btn-primary pt-1 pb-1 fs-5">
    ...
    <input type="hidden" value="{{route('partner.affiliate.fetch.data.ajax')}}" id="fetchListDataUrl" />
@endsection

@section('script')
    <script src="https://code.jquery.com/jquery-3.7.1.js"></script>
    <script src="https://cdn.datatables.net/2.0.2/js/dataTables.js"></script>
    <script src="{{ asset('assets/src/js/territory/affiliate.js') }}"></script>
@endsection
