	...
	<div class="row widget-grid">
        <div class="col-sm-12">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3"> 
                    <a href="{{route('default.show.users', ['type'=>'all-users', 'affiliate' => $affiliate->id])}}">
                        <div class="card widget-1">
                            <div class="card-body"> 
                                <div class="widget-content">
                                    <div> 
                ...
                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3"> 
                    <a href="{{route('default.show.users', ['type'=>'current-month', 'affiliate' => $affiliate->id])}}">
                        <div class="card widget-1">
                            <div class="card-body"> 
                                <div class="widget-content">
                                    <div> 
                ...
                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3"> 
                    <a href="{{route('default.show.users', ['type'=>'deactivated', 'affiliate' => $affiliate->id])}}">
                        <div class="card widget-1">
                            <div class="card-body"> 
                                <div class="widget-content">
                                    <div> 
