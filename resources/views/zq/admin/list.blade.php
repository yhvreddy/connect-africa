...
<div class="container-fluid">
  ...
  <div class="row widget-grid">
                    ...
                    <div class="card widget-1">
                        <div class="card-body">
                            <div class="widget-content">
                                <div>
                                    <h4>{{$users->count()}}</h4><span class="f-light">Total Admins</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-4">
                            <input type="search" class="form-control" placeholder="Admin" id="search" />
                        </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="table-responsive">
                            <table class="display" id="adminFetchDataToTable">
                                <thead>
                                    <tr>
                                        <th>Sno</th>
                                        <th>Name</th>
    ...
    <input type="hidden" value="{{route('zq.admins.fetch.data.ajax')}}" id="adminFetchListDataUrl" />
    <input type="hidden" value="{{ route('zq.admins.update.status', ['adminId' => ':adminId', 'action' => ':action']) }}" id="updateStatusUrl" />
...
@section('script')
    ...
    <script src="{{ asset('assets/src/js/admin/script.js') }}"></script>
@endsection
