...
@section('title', 'Deactivated Partners')
                        ...
                        <div class="card-body"> 
                            <div class="widget-content">
                                <div> 
                                    ...
                                    <span class="f-light">Total Partners</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3"> 
                    <div class="card widget-1">
                        <div class="card-body"> 
                            <div class="widget-content">
                                <div> 
                                    <h4>{{$deactivatePartners->count()}}</h4>
                                    <span class="f-light">Deactivated Partners</span>
                                </div>
                            </div>
