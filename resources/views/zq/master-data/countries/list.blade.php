...
<div class="container-fluid">
  ...
  <div class="row widget-grid">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <input type="search" class="form-control" placeholder="Countries" id="search" />
                        </div>
                        ...
                        <div class="col-3">
                            <a href="{{ route('zq.countries.create') }}" class="btn btn-primary float-end">Add Country</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <input type="hidden" value="{{route('zq.countries.fetch.data.ajax')}}" id="fetchListDataUrl" />
    <input type="hidden" value="{{ route('zq.countries.update.status', ['country' => ':country', 'action' => ':action']) }}" id="updateStatusUrl" />
...
@section('script')
    ...
    <script src="{{ asset('assets/src/js/master-data/countries/script.js') }}"></script>
@endsection
