...
@section('breadcrumb-items')
    ...
    <li class="breadcrumb-item active">Affiliate Users List</li>
@endsection
...
<div class="container-fluid">
    ...
    <input type="hidden" value="{{route('zq.affiliates.users.fetch.data.ajax')}}" id="fetchListDataUrl" />
    <input type="hidden" value="{{request()->type??null}}" id="requestType" />
    <input type="hidden" value="{{request()->affiliate}}" id="requestAffiliate" />
@endsection

@section('script')
    <script src="https://code.jquery.com/jquery-3.7.1.js"></script>
    <script src="https://cdn.datatables.net/2.0.2/js/dataTables.js"></script>
    <script src="{{ asset('assets/src/js/affiliates/users_script.js') }}"></script>
@endsection
