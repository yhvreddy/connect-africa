...
<div class="container-fluid">
                        ...
                        <div class="col-3 mb-2">
                            <select class="form-control" id="country_id" name="country_id">
                                ...
                                @foreach ($countries as $country)
                                    <option value="{{$country->id}}" {{(isset(request()->country_id) && request()->country_id == $country->id)?'selected':''}} >{{$country->name}}</option>
                                @endforeach
                            </select>
                        </div>
    ...
    <input type="hidden" value="{{route('zq.payments.fetch.data.ajax')}}" id="fetchDataToTableUrl" />
@endsection
...
@section('script')
    ...
    <script>
        let url = "{{route('zq.payments.index')}}";
